...
public class DanceFragment extends Fragment {
    ...
    private void initList() {
        list.add(new Emoji_Model("(:ㄏ■ Д ■ :)ㄏ"));
        list.add(new Emoji_Model("└(՞▃՞ └)"));
        list.add(new Emoji_Model("(～o▔▽▔)～oo～(▔▽▔o～)"));
        list.add(new Emoji_Model("（★ｏ☆）"));
        list.add(new Emoji_Model("♪ヽ( ⌒o⌒)人(⌒-⌒ )v ♪"));
        list.add(new Emoji_Model("╭(′▽`)╭(′▽`)╯"));
        list.add(new Emoji_Model("ヘ(^_^ヘ)"));
        list.add(new Emoji_Model("(ノ‥)ノ"));
        list.add(new Emoji_Model("┏(｀ー´)┛"));
        list.add(new Emoji_Model("♪(┌・。・)┌"));
        list.add(new Emoji_Model("ᕕ༼✪ل͜✪༽ᕗ"));
        list.add(new Emoji_Model("～(￣▽￣～)(～￣▽￣)～"));
        list.add(new Emoji_Model("(ノ^_^)ノ"));
        list.add(new Emoji_Model("(ﾉ^ω^)ﾉﾟ"));
        list.add(new Emoji_Model("┗(＾0＾)┓"));
        list.add(new Emoji_Model("ヽ(⌐■_■)ノ♪♬"));
        list.add(new Emoji_Model("ㄟ(▔〔▔ㄟ)(╯▔〔▔)╯"));
        list.add(new Emoji_Model("ヾ(^"));
        list.add(new Emoji_Model("。(⌒∇⌒。)"));
        list.add(new Emoji_Model("┏(＾0＾)┛"));
    }
}