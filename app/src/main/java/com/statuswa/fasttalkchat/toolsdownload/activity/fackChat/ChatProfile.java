...
import com.statuswa.fasttalkchat.toolsdownload.activity.fackChat.DataBaseDetails.DatabaseHelper;
...
public class ChatProfile extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(ChatProfile.this).loadInterstitialAd(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.save_userProfile:
                AppManage.getInstance(ChatProfile.this).showInterstitialAd(ChatProfile.this, new AppManage.MyCallback() {
