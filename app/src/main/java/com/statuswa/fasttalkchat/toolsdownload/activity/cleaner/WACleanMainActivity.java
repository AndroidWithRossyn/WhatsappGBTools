package com.statuswa.fasttalkchat.toolsdownload.activity.cleaner;
...
public class WACleanMainActivity extends AppCompatActivity {
    ...
    private class btnBackListner implements OnClickListener {
        ...
        public void onClick(View v) {
            AppManage.getInstance(WACleanMainActivity.this).showInterstitialAd(WACleanMainActivity.this, new AppManage.MyCallback() {
                public void callbackCall() {
                    WACleanMainActivity.super.onBackPressed();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(WACleanMainActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(WACleanMainActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
    ...
    private void ShowHelp() {
        ...
        TextView imageView = inflate.findViewById(R.id.btncancel);
