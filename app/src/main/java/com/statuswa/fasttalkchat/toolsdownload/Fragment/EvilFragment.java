...
public class EvilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_evil, container, false);
    ...
    private void initList() {
        list.add(new Emoji_Model("(◣∀◢)ψ"));
        list.add(new Emoji_Model("╭∩╮（￣▽￣）╭∩╮"));
        list.add(new Emoji_Model("凸(｀0´)凸"));
        list.add(new Emoji_Model("(╬￣皿￣)凸"));
        list.add(new Emoji_Model("｀(^▼^)´↑"));
        list.add(new Emoji_Model("Ψ (‘益’# )↝"));
        list.add(new Emoji_Model("（︶︿︶）＝凸"));
        list.add(new Emoji_Model("(╬▔〔▔)凸"));
        list.add(new Emoji_Model("ψ(*｀ー´)ψ"));
        list.add(new Emoji_Model("ψ(｀∇´)ψ"));
        list.add(new Emoji_Model("(╬▔＾▔)凸"));
