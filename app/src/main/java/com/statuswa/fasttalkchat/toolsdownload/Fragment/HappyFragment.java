...
public class HappyFragment extends Fragment {
    ...
    private void initList() {
        list.add(new Emoji_Model("(๑￫ܫ￩)"));
        list.add(new Emoji_Model("(͡o‿O͡)"));
        list.add(new Emoji_Model("(ﾉ≧ڡ≦)"));
        list.add(new Emoji_Model("(❍ᴥ❍ʋ)"));
        list.add(new Emoji_Model("(ᇴ‿ฺᇴ)"));
        list.add(new Emoji_Model("⊂◉‿◉つ"));
        list.add(new Emoji_Model("(✿◠‿◠)"));
        list.add(new Emoji_Model("(^)o(^)"));
        list.add(new Emoji_Model("ლ(╹◡╹ლ)"));
        list.add(new Emoji_Model("ლ(╹◡╹ლ)"));
        list.add(new Emoji_Model("（⌒▽⌒）"));
        list.add(new Emoji_Model("ಥ‿ಥ"));
        list.add(new Emoji_Model("✿◕ ‿ ◕✿"));
        list.add(new Emoji_Model("≧◉◡◉≦"));
        list.add(new Emoji_Model("（*^_^*）"));
        list.add(new Emoji_Model("o(∩_∩)o"));
        list.add(new Emoji_Model("(◠‿◠)"));
        list.add(new Emoji_Model("(●⌒∇⌒●)"));
        list.add(new Emoji_Model("◎[▪‿▪]◎"));
        list.add(new Emoji_Model("≧◠‿◠≦"));
        list.add(new Emoji_Model("( ͡° ͜ʖ ͡°)"));
        list.add(new Emoji_Model("ʘ‿ʘ"));
        list.add(new Emoji_Model("≖‿≖"));
        list.add(new Emoji_Model("(❁´◡`❁)"));
        list.add(new Emoji_Model("☆(❁‿❁)☆"));
        list.add(new Emoji_Model("٩(˘◡˘)۶"));
        list.add(new Emoji_Model("┑(￣▽￣)┍"));
        list.add(new Emoji_Model("(•ิ‿•ิ)"));
        list.add(new Emoji_Model("(◕‿◕)"));
    }
}