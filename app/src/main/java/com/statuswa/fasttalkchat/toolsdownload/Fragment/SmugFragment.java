...
public class SmugFragment extends Fragment {
    ...
    private void initList() {
        list.add(new Emoji_Model("┐( ͡° ʖ̯ ͡°)┌"));
        list.add(new Emoji_Model("┐( ͡◉ ͜ʖ ͡◉)┌"));
        list.add(new Emoji_Model("╮(╯∀╰)╭"));
        list.add(new Emoji_Model("¯_ȌᴥȌ_/¯"));
        list.add(new Emoji_Model("Y(^_^)Y"));
        list.add(new Emoji_Model("(￣▽￣)"));
        list.add(new Emoji_Model("ー(￣～￣)ξ"));
        list.add(new Emoji_Model("(＠￣︶￣＠)"));
        list.add(new Emoji_Model("（￣へ￣）"));
        list.add(new Emoji_Model("(￣ˇ￣)"));
        list.add(new Emoji_Model("o(￣ˇ￣)o"));
        list.add(new Emoji_Model("(￣ェ￣;)"));
        list.add(new Emoji_Model("╮(╯▽╰)╭"));
        list.add(new Emoji_Model("╮(￣▽￣)╭"));
