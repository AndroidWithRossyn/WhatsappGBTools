...
public class SadFragment extends Fragment {
    ...
    private void initList() {
        ...
        list.add(new Emoji_Model("( ⚈̥̥̥̥̥́⌢⚈̥̥̥̥̥̀)"));
        list.add(new Emoji_Model("ᕕ( ཀ ʖ̯ ཀ)ᕗ"));
        list.add(new Emoji_Model("(ಥ ͜ʖಥ)"));
        list.add(new Emoji_Model("ᕕ( ཀ ʖ̯ ཀ)ᕗ"));
        list.add(new Emoji_Model("( ◔ ʖ̯ ◔ )"));
        list.add(new Emoji_Model("(︶︹︺)"));
        list.add(new Emoji_Model("(◕︵◕)"));
        list.add(new Emoji_Model("⊙︿⊙"));
        list.add(new Emoji_Model("ˇ﹏ˇ"));
        list.add(new Emoji_Model("╥﹏╥"));
        list.add(new Emoji_Model("(~_~)"));
        list.add(new Emoji_Model("(个_个)"));
        list.add(new Emoji_Model("(´◔‸◔`)"));
        list.add(new Emoji_Model("(◕﹏◕✿)"));
        ...
        list.add(new Emoji_Model(":-("));
        list.add(new Emoji_Model("(〒︿〒﹀"));
        list.add(new Emoji_Model("ˇ︿ˇ"));
        list.add(new Emoji_Model("●︿●"));
        list.add(new Emoji_Model("(´°̥̥̥̥̥̥̥̥ω°̥̥̥̥̥̥̥̥｀)"));
        list.add(new Emoji_Model("(•̪●)"));
        list.add(new Emoji_Model("（︶^︶）"));
        list.add(new Emoji_Model("╯︿╰"));
        list.add(new Emoji_Model("⊙﹏⊙"));
        list.add(new Emoji_Model("(,Ծ‸Ծ,)"));
        list.add(new Emoji_Model("⊙︿⊙"));
    }
}