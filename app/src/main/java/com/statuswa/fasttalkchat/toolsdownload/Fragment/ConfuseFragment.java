...
public class ConfuseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_confuse, container, false);
    ...
    private void initList() {
        ...
        list.add(new Emoji_Model("(*ノз`*)"));
        list.add(new Emoji_Model("⊙△⊙"));
        list.add(new Emoji_Model("◑.◑"));
        list.add(new Emoji_Model("乁། ˵ ◕ – ◕ ˵ །ㄏ"));
    }
}